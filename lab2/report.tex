...
\newcommand{\infoneed}[2]{\item #1\\\textit{#2}}
\newenvironment{result}[2]{\item #2 \hfill{\small (#1)}\begin{quote}}{\end{quote}}
...
The full lists of results are available in \Vref{need-responses}.
\begin{enumerate}[{Information Need} 1:]
\item \begin{list}{}{}
  \item[Name:] I would like to know who among the legislators have been strongly opposed to the vaccination bill, and specifically, I would like to see what their arguments were

  \item[Query:] \itshape<PersonType:Legislator> freedom choice against oppose
  \end{list}
